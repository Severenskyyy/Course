...
export function CatalogPage() {
  const { books, hasRole, canReserveBook, createReservation, currentUser, addBook } = useApp();
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {/* === ADD BOOK MODAL === */}
      <Modal isOpen={addBookOpen} onClose={() => setAddBookOpen(false)} title="Добавить книгу" size="lg">
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <Input label="Код книги" value={newBook.book_code} onChange={(e) => setNewBook(p => ({ ...p, book_code: e.target.value }))} placeholder="BK0001" />
