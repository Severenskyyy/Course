...
|--------------------------|-----------------|------------------------------------------|
| Team Lead / Аналитик     | Кирбитов А.Е.   | ПИ — Информатизация организаций          |
...
| Документ                                                    | Где                                           |
|-------------------------------------------------------------|-----------------------------------------------|
| Карточка проекта                                            | `docs/00-governance/DOC-GOV-001-project-charter.md`      |
...
- **Инфраструктура:** GitHub, формат диаграмм: Mermaid + SVG
