...
| DOC-ARC-004    | UML Class diagram (связь компонентов)                 | [MD](../04-architecture/DOC-ARC-004-uml-class-diagram.md)               |
...
1. Демо UI-прототипа
2. Архитектурная схема системы (UML Component) — DOC-SPC-002
3. Связь компонентов (UML Class) — **DOC-ARC-004**
