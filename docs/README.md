...
| DOC-ARC-004 | UML Class diagram (связь компонентов) | `DOC-ARC-004-uml-class-diagram.md` |
| DOC-ARC-005 | Методика генерации макетов в Figma | `DOC-ARC-005-figma-wireframe-generation.md` |

> Папка `image/` содержит JPG-версии всех схем (архитектура, ERD, BPMN, DFD, CSV-обмен) для быстрого просмотра без открытия презентации.
...
|---|---|
| `DOC-GOV-001-project-charter.md` | `_docx/project-card.docx` |
| `DOC-GOV-001-project-charter.md` | `_docx/project-charter.docx` |
| `DOC-SPC-001-technical-specification.md` | `_docx/technical-specification-final.docx` |
